...
def test_loot_count_bis(player: Player, head_with_upgrade: Piece, weapon: Piece) -> None:
    assert abs(player.bis_count_total(head_with_upgrade)) == 0
    assert abs(player.bis_count_total(weapon)) == 0
    ...
    assert abs(player.bis_count_total(head_with_upgrade)) == 1
    assert abs(player.bis_count_total(weapon)) == 1
